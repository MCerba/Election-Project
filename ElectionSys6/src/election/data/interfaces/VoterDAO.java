...
/**
 * Interface that defines all behaviour required by a Data Access Object that deals with Voter
 * objects.
 * 
 * @author Jaya, Maja
 */
public interface VoterDAO {
   ...
   */
  void add(Voter voter) throws DuplicateVoterException;
   ...
   */
  Voter getVoter(String email) throws InexistentVoterException;
   ...
   */
  void update(Email email, PostalCode postalCode) throws InexistentVoterException;
