...
/**
 * Interface that defines all behaviour required by a class that loads from disk.
 * 
 * @author Jaya, Maja
 */
public interface ListPersistenceObject {
   ...
   * 
   * @param voters List of Voters to save
   * @throws IOException
   */
   ...
   * 
   * @param elections List of Elections to save
   * @throws IOException
   */
